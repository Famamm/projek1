...
return new class extends Migration
{
    ...
    {
        Schema::create('ajuan_cuti_keagamaans', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('tiket_keberangkatan')->nullable();
            $table->string('tiket_kepulangan')->nullable();
    ...
    {
        Schema::dropIfExists('ajuan_cuti_keagamaans');
    }
};
